...
const observer = new IntersectionObserver((entries) => {
  ...
  */
  ...
  let project_titles = ["To-do List App", "Ecommerce Landing Page", "Movie Sales Treemap Diagram"];
  let project_texts = [
    "The homepage of a To-do App.\n Which contains the tasks of the day, the upcoming tasks and the completed tasks.\n It also has the option of adding and removing a task.",
    "A project from freeCodeCamp Responsive Sites course with additional animations, transitions etc. Fully responsive and great UI.",
    "A data visualization page of the top 100 highest grossing movies grouped by genre.\n I used an API for the data and d3.js for the diagram."
  ];
  let img_srcs = [
    "./assets/images/to-do-list.png",
    "./assets/images/Ecommerce Landing Page.png",
    "./assets/images/Movie Sales Treemap Diagram.png"
  ];
  let demo_links = ["https://codepen.io/alfa_soul/full/xxmxJqq", "https://codepen.io/alfa_soul/full/LYXzzZG", "https://codepen.io/alfa_soul/full/GRwBBvK"];
  let code_links = ["#", "#", "#"];
  let index = 0;
  /*
